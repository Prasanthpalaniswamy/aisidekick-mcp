...
from ...models.delete_udf_values import DeleteUDFValues
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteUDFValues],
...
def sync_detailed(
    *,
    ...
    """Delete UDFValue
     ...
     Send a request to this endpoint to delete one or more UDFValue. Objects with ID values that match
