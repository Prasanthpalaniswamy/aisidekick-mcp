...
from ...models.delete_project_code_assignments import DeleteProjectCodeAssignments
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteProjectCodeAssignments],
...
def sync_detailed(
    *,
    ...
    """Delete Project Code Assignment
     ...
     Send a request to this endpoint to delete one or more ProjectCodeAssignment. An application object
