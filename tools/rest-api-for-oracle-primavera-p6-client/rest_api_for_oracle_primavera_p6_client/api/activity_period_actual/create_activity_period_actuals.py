    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        ...
        for response_201_item_data in _response_201:
            response_201_item = CreateProjectResourceQuantityResponse.from_dict(response_201_item_data)
...
def sync_detailed(
    *,
    ...
    """Create ActivityPeriodActuals
     ...
     Send a request to this endpoint to create one or more ActivityPeriodActuals. An application object
