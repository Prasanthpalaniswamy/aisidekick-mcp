...
from ...models.delete_activity_period_actuals import DeleteActivityPeriodActuals
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteActivityPeriodActuals],
...
def sync_detailed(
    *,
    ...
    """Delete ActivityPeriodActuals
     ...
     Send a request to this endpoint to delete one or more activityPeriodActual. Objects with ID values
