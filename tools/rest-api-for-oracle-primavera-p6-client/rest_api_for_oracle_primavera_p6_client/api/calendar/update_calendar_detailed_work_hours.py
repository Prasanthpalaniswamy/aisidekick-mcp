...
from ...models.set_detailed_work_hours import SetDetailedWorkHours
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: SetDetailedWorkHours,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/calendar/detailedWorkHours",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (SetDetailedWorkHours): SetDetailedWorkHours Entity
