...
from ...models.set_standard_detailed_work_hours import SetStandardDetailedWorkHours
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: SetStandardDetailedWorkHours,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/calendar/standardDetailedWorkHours",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (SetStandardDetailedWorkHours): SetStandardDetailedWorkHours Entity
