...
from ...models.delete_activity_risks import DeleteActivityRisks
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteActivityRisks],
...
def sync_detailed(
    *,
    ...
    """Delete ActivityRisk
     ...
     Send a request to this endpoint to delete one or more activityRisk. Objects with ID values that
