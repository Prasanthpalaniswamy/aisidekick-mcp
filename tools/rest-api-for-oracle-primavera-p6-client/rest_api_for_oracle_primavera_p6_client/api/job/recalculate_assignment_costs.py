...
from ...models.recalculate_assignment_costs import RecalculateAssignmentCosts
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[RecalculateAssignmentCosts],
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/job/recalculateAssignmentCosts",
    }
...
def sync_detailed(
    *,
    ...
    """RecalculateAssignmentCosts
     ...
     Asynchronously updates the resource and role assignment costs for the activities in the specified
    project.
