...
from ...models.overhead_code import OverheadCode
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[OverheadCode],
...
def sync_detailed(
    *,
    ...
    """Create OverheadCodes
     ...
     Send a request to this endpoint to create one or more overheadCode. An application object will be
