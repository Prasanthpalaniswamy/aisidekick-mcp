...
def sync_detailed(
    *,
    ...
    """Update ResourceCodeTypes
     ...
     Updates multiple ResourceCodeType objects in the database. You can update up to 1000
    ResourceCodeType objects with a single call.
