...
from ...models.resource_hour import ResourceHour
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ResourceHour],
...
def sync_detailed(
    *,
    ...
    """Update ResourceHour
     ...
     Send a request to this endpoint to update one or more ResourceHour. An application object will be
