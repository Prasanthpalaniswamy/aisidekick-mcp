...
from ...models.update_resource_assignment_spread import UpdateResourceAssignmentSpread
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: UpdateResourceAssignmentSpread,
...
def sync_detailed(
    *,
    ...
    """Update ResourceAssignmentSpread
     ...
     Send a request to this endpoint to update one or more ResourceAssignmentSpread. An application
    object will be created for each JSON object provided in the request body

    Args:
        auth_token (str | Unset):
        body (UpdateResourceAssignmentSpread): UpdateResourceAssignmentSpread Entity
