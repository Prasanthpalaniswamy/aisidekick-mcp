...
from ...models.read_project_spread_response import ReadProjectSpreadResponse
...
) -> Any | list[ReadProjectSpreadResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ReadProjectSpreadResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | list[ReadProjectSpreadResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | list[ReadProjectSpreadResponse]
    """
