...
from ...models.read_resource_assignment_spread_response import ReadResourceAssignmentSpreadResponse
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    resource_assignment_object_id: str,
    period_type: str,
    ...
    params["ResourceAssignmentObjectId"] = resource_assignment_object_id
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/spread/resourceAssignmentSpread",
        "params": params,
    }
...
) -> Any | list[ReadResourceAssignmentSpreadResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ReadResourceAssignmentSpreadResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | list[ReadResourceAssignmentSpreadResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | list[ReadResourceAssignmentSpreadResponse]
    """
