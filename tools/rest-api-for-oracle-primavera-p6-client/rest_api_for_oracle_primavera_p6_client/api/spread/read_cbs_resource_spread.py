...
from ...models.read_cbs_resource_spread_response import ReadCBSResourceSpreadResponse
...
def _get_kwargs(
    *,
    ...
    summary_date_field: str | Unset = UNSET,
    spread_field: str,
    ...
    params["SummaryDateField"] = summary_date_field
...
) -> Any | list[ReadCBSResourceSpreadResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ReadCBSResourceSpreadResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | list[ReadCBSResourceSpreadResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | list[ReadCBSResourceSpreadResponse]
    """
