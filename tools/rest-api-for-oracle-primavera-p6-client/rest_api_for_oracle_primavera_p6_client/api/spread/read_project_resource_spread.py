...
from ...models.read_project_resource_spread_response import ReadProjectResourceSpreadResponse
...
def _get_kwargs(
    *,
    ...
    resource_object_id: str | Unset = UNSET,
    ...
    params["ResourceObjectId"] = resource_object_id
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/spread/projectResourceSpread",
        "params": params,
    }
...
) -> Any | list[ReadProjectResourceSpreadResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ReadProjectResourceSpreadResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | list[ReadProjectResourceSpreadResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | list[ReadProjectResourceSpreadResponse]
    """
