...
from ...models.delete_risk_response_action_impacts import DeleteRiskResponseActionImpacts
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteRiskResponseActionImpacts],
...
def sync_detailed(
    *,
    ...
    """Delete RiskResponseActionImpacts
     ...
     Send a request to this endpoint to delete one or more riskResponseActionImpact. Objects with ID
    values that match the values provided in the request body will be deleted.
