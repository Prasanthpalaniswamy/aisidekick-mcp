...
from ...models.delete_timesheets import DeleteTimesheets
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteTimesheets],
...
def sync_detailed(
    *,
    ...
    """Delete Timesheet
     ...
     Send a request to this endpoint to delete one or more timesheet. An application object will be
