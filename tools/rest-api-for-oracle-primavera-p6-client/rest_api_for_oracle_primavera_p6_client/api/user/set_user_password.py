...
def sync_detailed(
    *,
    ...
    """SetUserPassword Operation
     ...
     Sets User Password. You must supply the UserObjectId and OldPassword fields when you use the
    SetUserPassword operation. If you are an Admin Superuser, the OldPassword field is not required.
