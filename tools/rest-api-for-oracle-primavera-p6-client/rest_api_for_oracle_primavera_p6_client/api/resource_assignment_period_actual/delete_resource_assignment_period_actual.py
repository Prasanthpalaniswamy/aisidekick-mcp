...
from ...models.delete_resource_assignment_period_actuals import DeleteResourceAssignmentPeriodActuals
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteResourceAssignmentPeriodActuals],
...
def sync_detailed(
    *,
    ...
    """Delete ResourceAssignmentPeriodActual
     ...
     Send a request to this endpoint to delete one or more ResourceAssignmentPeriodActual. An application
