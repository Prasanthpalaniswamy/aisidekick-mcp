...
from ...models.baseline_project import BaselineProject
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[BaselineProject],
...
def sync_detailed(
    *,
    ...
    """Update BaselineProjects
     ...
     Send a request to this endpoint to update one or more baselineProject. For each JSON object provided
    in the request body, an application object with a matching ID value will be updated to reflect the
    JSON contents.
