...
from ...models.activity_filter import ActivityFilter
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ActivityFilter],
...
def sync_detailed(
    *,
    ...
    """Update ActivityFilters
     ...
     Send a request to this endpoint to update one or more activityFilter. For each JSON object provided
