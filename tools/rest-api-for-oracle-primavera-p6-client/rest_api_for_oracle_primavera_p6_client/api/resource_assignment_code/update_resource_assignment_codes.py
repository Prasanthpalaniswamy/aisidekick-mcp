...
def _get_kwargs(
    *,
    body: list[ResourceAssignmentCode],
...
def sync_detailed(
    *,
    ...
    """Update ResourceAssignmentCodes
     ...
     Updates multiple ResourceAssignmentCode objects in the database. You can update up to 1000
    ResourceAssignmentCode objects with a single call.
