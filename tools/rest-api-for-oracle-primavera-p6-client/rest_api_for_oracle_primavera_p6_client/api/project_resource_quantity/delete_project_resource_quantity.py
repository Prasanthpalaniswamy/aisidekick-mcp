...
from ...models.delete_project_resource_quantities import DeleteProjectResourceQuantities
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteProjectResourceQuantities],
...
def sync_detailed(
    *,
    ...
    """Delete ProjectResourceQuantity
     ...
     Send a request to this endpoint to delete one or more ProjectResourceQuantity. An application object
