...
from ...models.activity_step import ActivityStep
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ActivityStep],
...
def sync_detailed(
    *,
    ...
    """Create ActivitySteps
     ...
     Send a request to this endpoint to create one or more activityStep. An application object will be
