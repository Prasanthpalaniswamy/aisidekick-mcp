...
from ...models.delete_role_code_assignments import DeleteRoleCodeAssignments
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteRoleCodeAssignments],
...
def sync_detailed(
    *,
    ...
    """Delete RoleCodeAssignments
     ...
     Send a request to this endpoint to delete one or more roleCodeAssignment. Objects with ID values
