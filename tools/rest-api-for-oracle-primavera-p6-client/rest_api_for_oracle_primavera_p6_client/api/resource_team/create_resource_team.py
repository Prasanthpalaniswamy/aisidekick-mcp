...
from ...models.resource_team import ResourceTeam
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ResourceTeam],
...
def sync_detailed(
    *,
    ...
    """Create ResourceTeam
     ...
     Send a request to this endpoint to create one or more ResourceTeam. An application object will be
