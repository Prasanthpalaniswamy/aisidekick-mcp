...
from ...models.delete_user_obs import DeleteUserOBS
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteUserOBS],
...
def sync_detailed(
    *,
    ...
    """Delete UserOBS
     ...
     Send a request to this endpoint to delete one or more UserOBS. An application object will be created
