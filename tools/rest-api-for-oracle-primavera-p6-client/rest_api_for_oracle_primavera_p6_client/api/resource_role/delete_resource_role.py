...
from ...models.delete_resource_roles import DeleteResourceRoles
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteResourceRoles],
...
def sync_detailed(
    *,
    ...
    """Delete ResourceRole
     ...
     Send a request to this endpoint to delete one or more ResourceRole. Objects with ID values that
