...
from ...models.wbs_milestone import WBSMilestone
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[WBSMilestone],
...
def sync_detailed(
    *,
    ...
    """Update WBSMilestone
     ...
     Send a request to this endpoint to update one or more WBSMilestone. An application object will be
