...
from ...models.delete_resource_access import DeleteResourceAccess
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteResourceAccess],
...
def sync_detailed(
    *,
    ...
    """Delete ResourceAccess
     ...
     Send a request to this endpoint to delete one or more resourceAccess. Objects with ID values that
    match the values provided in the request body will be deleted.
