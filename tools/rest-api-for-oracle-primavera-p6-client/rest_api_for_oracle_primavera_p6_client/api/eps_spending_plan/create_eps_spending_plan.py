...
from ...models.eps_spending_plan import EPSSpendingPlan
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[EPSSpendingPlan],
...
def sync_detailed(
    *,
    ...
    """Create EPSSpendingPlan
     ...
     Send a request to this endpoint to create one or more EPSSpendingPlan. An application object will be
