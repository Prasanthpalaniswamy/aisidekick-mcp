...
def sync_detailed(
    *,
    ...
    """Update ResourceLocation
     ...
     Updates multiple ResourceLocation objects in the database. You can update up to 1000
    ResourceLocation objects with a single call.
