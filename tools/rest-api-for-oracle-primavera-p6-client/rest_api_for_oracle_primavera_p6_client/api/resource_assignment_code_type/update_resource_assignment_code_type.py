...
def _get_kwargs(
    *,
    body: list[ResourceAssignmentCodeType],
...
def sync_detailed(
    *,
    ...
    """Update ResourceAssignmentCodeType
     ...
     Updates multiple ResourceAssignmentCodeType objects in the database. You can update up to 1000
    ResourceAssignmentCodeType objects with a single call.
