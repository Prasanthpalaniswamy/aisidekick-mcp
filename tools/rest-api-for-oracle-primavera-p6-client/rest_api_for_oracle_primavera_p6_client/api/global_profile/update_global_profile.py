...
from ...models.global_profile import GlobalProfile
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[GlobalProfile],
...
def sync_detailed(
    *,
    ...
    """Update GlobalProfile
     ...
     Send a request to this endpoint to update one or more GlobalProfile. An application object will be
