...
from ...models.load_projects_response import LoadProjectsResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projectPortfolio/loadProjects",
        "params": params,
    }
...
) -> Any | LoadProjectsResponse | None:
    if response.status_code == 200:
        response_200 = LoadProjectsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | LoadProjectsResponse]:
    return Response(
