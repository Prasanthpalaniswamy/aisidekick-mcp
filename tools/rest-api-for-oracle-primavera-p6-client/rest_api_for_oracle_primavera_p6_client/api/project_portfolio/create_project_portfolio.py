...
from ...models.project_portfolio import ProjectPortfolio
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ProjectPortfolio],
...
def sync_detailed(
    *,
    ...
    """Create ProjectPortfolio
     ...
     Send a request to this endpoint to create one or more ProjectPortfolio. An application object will
