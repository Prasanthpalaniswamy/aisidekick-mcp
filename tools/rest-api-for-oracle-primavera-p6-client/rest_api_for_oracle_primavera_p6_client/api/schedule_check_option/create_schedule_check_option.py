...
from ...models.schedule_check_option import ScheduleCheckOption
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ScheduleCheckOption],
...
def sync_detailed(
    *,
    ...
    """Create ScheduleCheckOption
     ...
     Send a request to this endpoint to create ScheduleCheckOption. An application object will be created
