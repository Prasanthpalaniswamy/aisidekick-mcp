...
from ...models.delete_resource_assignment_updates import DeleteResourceAssignmentUpdates
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteResourceAssignmentUpdates],
...
def sync_detailed(
    *,
    ...
    """Delete ResourceAssignmentUpdate
     ...
     Send a request to this endpoint to delete one or more ResourceAssignmentUpdate. An application
