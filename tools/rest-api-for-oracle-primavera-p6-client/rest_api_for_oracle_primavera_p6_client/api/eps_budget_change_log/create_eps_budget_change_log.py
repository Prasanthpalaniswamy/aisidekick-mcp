...
from ...models.eps_budget_change_log import EPSBudgetChangeLog
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[EPSBudgetChangeLog],
...
def sync_detailed(
    *,
    ...
    """Create EPSBudgetChangeLog to the store
     ...
     Send a request to this endpoint to create one or more Project. An application object will be created
