...
from ...models.delete_resource_code_assignments import DeleteResourceCodeAssignments
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteResourceCodeAssignments],
...
def sync_detailed(
    *,
    ...
    """Delete ResourceCodeAssignment
     ...
     Send a request to this endpoint to delete one or more ResourceCodeAssignment. An application object
