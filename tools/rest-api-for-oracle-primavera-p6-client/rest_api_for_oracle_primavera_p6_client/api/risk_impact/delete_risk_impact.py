...
from ...models.delete_risk_impacts import DeleteRiskImpacts
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteRiskImpacts],
...
def sync_detailed(
    *,
    ...
    """Delete RiskImpacts
     ...
     Send a request to this endpoint to delete one or more riskImpact. Objects with ID values that match
    the values provided in the request body will be deleted.
