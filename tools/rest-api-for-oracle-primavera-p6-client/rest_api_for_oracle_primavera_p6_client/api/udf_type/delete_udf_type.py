...
def sync_detailed(
    *,
    ...
    """Delete UDFTypes
     ...
     Send a request to this endpoint to delete one or more UDFType. Objects with ID values that match the
    values provided in the request body will be deleted.
