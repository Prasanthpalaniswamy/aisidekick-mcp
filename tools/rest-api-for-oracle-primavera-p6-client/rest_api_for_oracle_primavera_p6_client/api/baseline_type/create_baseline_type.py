...
from ...models.baseline_type import BaselineType
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[BaselineType],
...
def sync_detailed(
    *,
    ...
    """Create BaselineTypes
     ...
     Send a request to this endpoint to create one or more baselineType. An application object will be
