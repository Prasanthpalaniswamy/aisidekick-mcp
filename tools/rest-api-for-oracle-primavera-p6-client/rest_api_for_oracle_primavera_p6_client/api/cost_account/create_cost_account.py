...
from ...models.cost_account import CostAccount
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[CostAccount],
...
def sync_detailed(
    *,
    ...
    """Create CostAccount
     ...
     Send a request to this endpoint to create one or more CostAccount. An application object will be
