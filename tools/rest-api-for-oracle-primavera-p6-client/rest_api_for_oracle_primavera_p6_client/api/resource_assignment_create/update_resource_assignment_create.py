...
def _get_kwargs(
    *,
    body: list[ResourceAssignmentCreate],
...
def sync_detailed(
    *,
    ...
    """Update ResourceAssignmentCreate
     ...
     Send a request to this endpoint to update one or more ResourceAssignmentCreate. An application
    object will be created for each JSON object provided in the request body.
    ResourceAssignmentCreateObjectId is mandatory field
