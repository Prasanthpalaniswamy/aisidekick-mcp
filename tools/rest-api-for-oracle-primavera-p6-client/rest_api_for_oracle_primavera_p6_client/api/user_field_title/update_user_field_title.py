...
from ...models.user_field_title import UserFieldTitle
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[UserFieldTitle],
...
def sync_detailed(
    *,
    ...
    """Update UserFieldTitles
     ...
     Send a request to this endpoint to update one or more userFieldTitle. For each JSON object provided
