...
from ...models.delete_activity_code_assignments import DeleteActivityCodeAssignments
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteActivityCodeAssignments],
...
def sync_detailed(
    *,
    ...
    """Delete ActivityCodeAssignments
     ...
     Send a request to this endpoint to delete one or more activityCodeAssignment. Objects with ID values
