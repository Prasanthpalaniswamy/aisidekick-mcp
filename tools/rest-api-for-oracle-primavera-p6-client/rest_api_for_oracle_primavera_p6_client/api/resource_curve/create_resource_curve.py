...
from ...models.resource_curve import ResourceCurve
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ResourceCurve],
...
def sync_detailed(
    *,
    ...
    """Create ResourceCurve
     ...
     Send a request to this endpoint to create one or more ResourceCurve. An application object will be
