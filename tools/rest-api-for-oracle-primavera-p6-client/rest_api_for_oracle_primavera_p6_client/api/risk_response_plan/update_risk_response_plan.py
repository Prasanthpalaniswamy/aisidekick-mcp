...
from ...models.risk_response_plan import RiskResponsePlan
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[RiskResponsePlan],
...
def sync_detailed(
    *,
    ...
    """Update RiskResponsePlans
     ...
     Send a request to this endpoint to update one or more riskResponsePlan. For each JSON object
