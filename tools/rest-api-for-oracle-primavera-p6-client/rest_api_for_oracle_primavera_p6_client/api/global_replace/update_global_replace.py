...
from ...models.global_replace import GlobalReplace
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[GlobalReplace],
...
def sync_detailed(
    *,
    ...
    """Update GlobalReplace
     ...
     Send a request to this endpoint to update one or more GlobalReplace. For each JSON object provided
