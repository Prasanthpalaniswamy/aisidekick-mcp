...
from ...models.delete_risk_matrix_thresholds import DeleteRiskMatrixThresholds
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[DeleteRiskMatrixThresholds],
...
def sync_detailed(
    *,
    ...
    """Delete RiskMatrixThresholds
     ...
     Send a request to this endpoint to delete one or more riskMatrixThreshold. Objects with ID values
