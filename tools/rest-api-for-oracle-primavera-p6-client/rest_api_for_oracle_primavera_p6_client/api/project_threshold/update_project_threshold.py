...
from ...models.project_threshold import ProjectThreshold
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: list[ProjectThreshold],
...
def sync_detailed(
    *,
    ...
    """Update ProjectThreshold
     ...
     Send a request to this endpoint to update one or more ProjectThreshold. An application object will
