...
from ..models.resource_assignment_field_item import ResourceAssignmentFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResourceAssignment")
...
class ResourceAssignment:
    ...
    Attributes:
        ...
        field (list[ResourceAssignmentFieldItem] | Unset): List of Fields for ResourceAssignment Business Object
    """

    include: bool | Unset = UNSET
    field: list[ResourceAssignmentFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ResourceAssignmentFieldItem(field_item_data)

                field.append(field_item)

        resource_assignment = cls(
            include=include,
            field=field,
        )

        resource_assignment.additional_properties = d
