...
T = TypeVar("T", bound="ApplyActuals")
...
class ApplyActuals:
    ...
    Attributes:
        ...
        new_data_date (datetime.datetime | Unset): The unique identifier of the project you want to summarize.
        timeout (int | Unset): The unique identifier of the project you want to summarize.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        apply_actuals.additional_properties = d
        return apply_actuals
