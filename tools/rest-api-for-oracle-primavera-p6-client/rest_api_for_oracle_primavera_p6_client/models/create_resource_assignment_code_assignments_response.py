...
T = TypeVar("T", bound="CreateResourceAssignmentCodeAssignmentsResponse")


@_attrs_define
class CreateResourceAssignmentCodeAssignmentsResponse:
    """CreateResourceAssignmentCodeAssignmentsResponse Entity

    Attributes:
        resource_assignment_object_id (int | Unset):
        resource_assignment_code_type_object_id (int | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_resource_assignment_code_assignments_response = cls(
        ...
        create_resource_assignment_code_assignments_response.additional_properties = d
        return create_resource_assignment_code_assignments_response
