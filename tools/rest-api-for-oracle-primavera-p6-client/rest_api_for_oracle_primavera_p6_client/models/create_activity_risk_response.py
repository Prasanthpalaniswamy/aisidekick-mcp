...
T = TypeVar("T", bound="CreateActivityRiskResponse")


@_attrs_define
class CreateActivityRiskResponse:
    """CreateActivityRiskResponse Entity

    Attributes:
        risk_object_id (int | Unset): The unique ID of the associated risk.
        activity_object_id (int | Unset): The unique ID of the activity to which the risk is assigned.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_activity_risk_response = cls(
            risk_object_id=risk_object_id,
            activity_object_id=activity_object_id,
        )

        create_activity_risk_response.additional_properties = d
        return create_activity_risk_response
