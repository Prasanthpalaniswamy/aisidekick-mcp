...
from ..models.resource_code_field_item import ResourceCodeFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResourceCode")
...
class ResourceCode:
    ...
    Attributes:
        ...
        field (list[ResourceCodeFieldItem] | Unset): List of Fields for ResourceCode Business Object
    """

    include: bool | Unset = UNSET
    field: list[ResourceCodeFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ResourceCodeFieldItem(field_item_data)
        ...
        resource_code.additional_properties = d
