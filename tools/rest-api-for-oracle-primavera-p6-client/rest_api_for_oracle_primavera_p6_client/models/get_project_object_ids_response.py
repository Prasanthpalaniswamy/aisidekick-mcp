...
T = TypeVar("T", bound="GetProjectObjectIdsResponse")


@_attrs_define
class GetProjectObjectIdsResponse:
    """
    Attributes:
        project_object_ids (list[int] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_project_object_ids_response = cls(
            project_object_ids=project_object_ids,
        )

        get_project_object_ids_response.additional_properties = d
        return get_project_object_ids_response
