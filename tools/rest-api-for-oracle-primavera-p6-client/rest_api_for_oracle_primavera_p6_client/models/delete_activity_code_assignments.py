...
T = TypeVar("T", bound="DeleteActivityCodeAssignments")
...
class DeleteActivityCodeAssignments:
    ...
    Attributes:
        ...
        activity_code_type_object_id (int | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_activity_code_assignments = cls(
            activity_object_id=activity_object_id,
            activity_code_type_object_id=activity_code_type_object_id,
        )

        delete_activity_code_assignments.additional_properties = d
        return delete_activity_code_assignments
