...
T = TypeVar("T", bound="GlobalProfile")
...
class GlobalProfile:
    ...
    Attributes:
        create_date (datetime.datetime | Unset): The date this Global Profile was created.
        create_user (str | Unset): The name of the user that created this Global Profile.
        is_default (bool | Unset): The flag that indicates this security profile is assigned to new users by default.
            When a GlobalProfile object is deleted from the database, all users assigned to that profile are reassigned to
            the default profile. You cannot not delete the default profile.
        is_super_user (bool | Unset): The flag that identifies the superuser profile. Superuser profiles are
            automatically granted all privileges.
        last_update_date (datetime.datetime | Unset): The date this Global Profile was last updated.
        last_update_user (str | Unset): The name of the user that last updated this Global Profile.
        name (str | Unset): The privileges that are turned on.
        object_id (int | Unset): The unique ID generated by the system.
        privilege (list[Privilege] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_profile.additional_properties = d
