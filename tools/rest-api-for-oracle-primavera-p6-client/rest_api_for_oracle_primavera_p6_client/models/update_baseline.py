...
T = TypeVar("T", bound="UpdateBaseline")
...
class UpdateBaseline:
    ...
    Attributes:
        object_id (int | Unset): The unique identifier for the job.
        baseline_proj_id (int | Unset): The unique identifier for the baseline project.
    ...
    baseline_proj_id: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        baseline_proj_id = self.baseline_proj_id
        ...
        if baseline_proj_id is not UNSET:
            field_dict["BaselineProjId"] = baseline_proj_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        baseline_proj_id = d.pop("BaselineProjId", UNSET)
        ...
        update_baseline.additional_properties = d
