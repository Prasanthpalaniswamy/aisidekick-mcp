...
from ..models.project_issue_field_item import ProjectIssueFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectIssue")
...
class ProjectIssue:
    ...
    Attributes:
        ...
        field (list[ProjectIssueFieldItem] | Unset): List of Fields for ProjectIssue Business Object
    """

    include: bool | Unset = UNSET
    field: list[ProjectIssueFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ProjectIssueFieldItem(field_item_data)
        ...
        project_issue.additional_properties = d
