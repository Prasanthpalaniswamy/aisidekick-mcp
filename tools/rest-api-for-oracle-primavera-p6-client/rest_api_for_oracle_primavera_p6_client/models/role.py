...
from ..models.role_field_item import RoleFieldItem
...
class Role:
    ...
    Attributes:
        ...
        field (list[RoleFieldItem] | Unset): List of Fields for Role Business Object
    """

    include: bool | Unset = UNSET
    field: list[RoleFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = RoleFieldItem(field_item_data)
