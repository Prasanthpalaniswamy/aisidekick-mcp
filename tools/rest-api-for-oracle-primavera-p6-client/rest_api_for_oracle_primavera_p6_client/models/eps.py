...
from ..models.eps_field_item import EPSFieldItem
...
class EPS:
    ...
    Attributes:
        ...
        field (list[EPSFieldItem] | Unset): List of Fields for EPS Business Object
    """

    include: bool | Unset = UNSET
    field: list[EPSFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = EPSFieldItem(field_item_data)
