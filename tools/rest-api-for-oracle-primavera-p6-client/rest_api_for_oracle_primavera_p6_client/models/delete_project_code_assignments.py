...
T = TypeVar("T", bound="DeleteProjectCodeAssignments")


@_attrs_define
class DeleteProjectCodeAssignments:
    """DeleteProjectCodeAssignments Entity

    Attributes:
        project_object_id (int | Unset):
        project_code_type_object_id (int | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_project_code_assignments = cls(
            project_object_id=project_object_id,
            project_code_type_object_id=project_code_type_object_id,
        )

        delete_project_code_assignments.additional_properties = d
        return delete_project_code_assignments
