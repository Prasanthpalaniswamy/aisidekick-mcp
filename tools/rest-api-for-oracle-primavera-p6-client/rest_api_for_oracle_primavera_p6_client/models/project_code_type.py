...
from ..models.project_code_type_field_item import ProjectCodeTypeFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCodeType")
...
class ProjectCodeType:
    ...
    Attributes:
        ...
        field (list[ProjectCodeTypeFieldItem] | Unset): List of Fields for ProjectCodeType Business Object
    """

    include: bool | Unset = UNSET
    field: list[ProjectCodeTypeFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ProjectCodeTypeFieldItem(field_item_data)

                field.append(field_item)

        project_code_type = cls(
            include=include,
            field=field,
        )

        project_code_type.additional_properties = d
        return project_code_type
