...
T = TypeVar("T", bound="DeleteRiskImpacts")


@_attrs_define
class DeleteRiskImpacts:
    """DeleteRiskImpacts Entity
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_risk_impacts = cls(
            risk_object_id=risk_object_id,
            risk_threshold_object_id=risk_threshold_object_id,
        )

        delete_risk_impacts.additional_properties = d
        return delete_risk_impacts
