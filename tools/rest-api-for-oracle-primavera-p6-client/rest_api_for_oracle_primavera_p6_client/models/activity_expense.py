...
from ..models.activity_expense_field_item import ActivityExpenseFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ActivityExpense")
...
class ActivityExpense:
    ...
    Attributes:
        ...
        field (list[ActivityExpenseFieldItem] | Unset): ActivityExpenseFieldType: List of Fields for ActivityExpense
            Business Object
    """

    include: bool | Unset = UNSET
    field: list[ActivityExpenseFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ActivityExpenseFieldItem(field_item_data)

                field.append(field_item)

        activity_expense = cls(
            include=include,
            field=field,
        )

        activity_expense.additional_properties = d
        return activity_expense
