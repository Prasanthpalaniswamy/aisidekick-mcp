...
T = TypeVar("T", bound="DeleteResourceAssignmentCodeAssignments")


@_attrs_define
class DeleteResourceAssignmentCodeAssignments:
    """DeleteResourceAssignmentCodeAssignments Entity
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_assignment_code_assignments = cls(
        ...
        delete_resource_assignment_code_assignments.additional_properties = d
        return delete_resource_assignment_code_assignments
