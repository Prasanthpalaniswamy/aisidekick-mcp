...
from ..models.activity_code_export_field_item import ActivityCodeExportFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ActivityCodeExport")


@_attrs_define
class ActivityCodeExport:
    """
    Attributes:
        ...
        field (list[ActivityCodeExportFieldItem] | Unset): List of Fields for ActivityCode Business Object
    """

    include: bool | Unset = UNSET
    field: list[ActivityCodeExportFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ActivityCodeExportFieldItem(field_item_data)

                field.append(field_item)

        activity_code_export = cls(
            include=include,
            field=field,
        )

        activity_code_export.additional_properties = d
        return activity_code_export
