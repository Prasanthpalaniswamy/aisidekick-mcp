...
from ..models.resource_role_field_item import ResourceRoleFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResourceRole")
...
class ResourceRole:
    ...
    Attributes:
        ...
        field (list[ResourceRoleFieldItem] | Unset): List of Fields for ResourceRole Business Object
    """

    include: bool | Unset = UNSET
    field: list[ResourceRoleFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ResourceRoleFieldItem(field_item_data)
        ...
        resource_role.additional_properties = d
