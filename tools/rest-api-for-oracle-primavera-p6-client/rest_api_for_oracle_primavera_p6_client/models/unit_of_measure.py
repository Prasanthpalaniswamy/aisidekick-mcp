...
T = TypeVar("T", bound="UnitOfMeasure")
...
class UnitOfMeasure:
    ...
    Attributes:
        abbreviation (str | Unset): The abbreviation of the unit of measure.
        create_date (datetime.datetime | Unset): The date this unit of measure was created.
        create_user (str | Unset): The name of the user that created this unit of measure.
        last_update_date (datetime.datetime | Unset): The date this unit of measure was last updated.
        last_update_user (str | Unset): The name of the user that last updated this unit of measure.
        name (str | Unset): The name of the unit of measure.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unit_of_measure.additional_properties = d
