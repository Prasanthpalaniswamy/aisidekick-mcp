...
from ..models.project_document_field_item import ProjectDocumentFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectDocument")
...
class ProjectDocument:
    ...
    Attributes:
        ...
        field (list[ProjectDocumentFieldItem] | Unset): List of Fields for ProjectDocument Business Object
    """

    include: bool | Unset = UNSET
    field: list[ProjectDocumentFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ProjectDocumentFieldItem(field_item_data)
        ...
        project_document.additional_properties = d
