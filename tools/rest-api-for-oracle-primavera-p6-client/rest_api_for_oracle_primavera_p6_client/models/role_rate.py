...
from ..models.role_rate_field_item import RoleRateFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoleRate")
...
class RoleRate:
    ...
    Attributes:
        ...
        field (list[RoleRateFieldItem] | Unset): List of Fields for RoleRate Business Object
    """

    include: bool | Unset = UNSET
    field: list[RoleRateFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = RoleRateFieldItem(field_item_data)
        ...
        role_rate.additional_properties = d
        return role_rate
