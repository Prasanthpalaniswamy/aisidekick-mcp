...
T = TypeVar("T", bound="DeleteUDFValues")


@_attrs_define
class DeleteUDFValues:
    """DeleteUDFValues Entity

    Attributes:
        foreign_object_id (int | Unset):
        udf_type_object_id (int | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_udf_values = cls(
            foreign_object_id=foreign_object_id,
            udf_type_object_id=udf_type_object_id,
        )

        delete_udf_values.additional_properties = d
        return delete_udf_values
