...
T = TypeVar("T", bound="StorePeriodPerformance")


@_attrs_define
class StorePeriodPerformance:
    """StorePeriodPerformance Entity

    Attributes:
        project_object_id (int | Unset): The unique identifier of the associated project.
        financial_period_object_id (int | Unset): The unique identifier of the associated financial period.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        store_period_performance = cls(
            project_object_id=project_object_id,
            financial_period_object_id=financial_period_object_id,
            timeout=timeout,
        )

        store_period_performance.additional_properties = d
        return store_period_performance
