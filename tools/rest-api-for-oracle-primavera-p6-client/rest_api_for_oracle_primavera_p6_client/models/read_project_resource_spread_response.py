...
T = TypeVar("T", bound="ReadProjectResourceSpreadResponse")


@_attrs_define
class ReadProjectResourceSpreadResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        read_project_resource_spread_response = cls(
        ...
        read_project_resource_spread_response.additional_properties = d
        return read_project_resource_spread_response
