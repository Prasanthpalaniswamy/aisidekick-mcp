...
from ..models.funding_source_field_item import FundingSourceFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="FundingSource")
...
class FundingSource:
    ...
    Attributes:
        ...
        field (list[FundingSourceFieldItem] | Unset): List of Fields for FundingSource Business Object
    """

    include: bool | Unset = UNSET
    field: list[FundingSourceFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = FundingSourceFieldItem(field_item_data)
        ...
        funding_source.additional_properties = d
