...
from ..models.risk_matrix_score_field_item import RiskMatrixScoreFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="RiskMatrixScore")
...
class RiskMatrixScore:
    ...
    Attributes:
        ...
        field (list[RiskMatrixScoreFieldItem] | Unset): List of Fields for RiskMatrixScore Business Object
    """

    include: bool | Unset = UNSET
    field: list[RiskMatrixScoreFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = RiskMatrixScoreFieldItem(field_item_data)

                field.append(field_item)

        risk_matrix_score = cls(
            include=include,
            field=field,
        )

        risk_matrix_score.additional_properties = d
        return risk_matrix_score
