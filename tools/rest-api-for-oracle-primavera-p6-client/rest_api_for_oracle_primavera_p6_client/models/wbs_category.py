...
from ..models.wbs_category_field_item import WBSCategoryFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="WBSCategory")
...
class WBSCategory:
    ...
    Attributes:
        ...
        field (list[WBSCategoryFieldItem] | Unset): List of Fields for WBSCategory Business Object
    """

    include: bool | Unset = UNSET
    field: list[WBSCategoryFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = WBSCategoryFieldItem(field_item_data)
        ...
        wbs_category.additional_properties = d
        return wbs_category
