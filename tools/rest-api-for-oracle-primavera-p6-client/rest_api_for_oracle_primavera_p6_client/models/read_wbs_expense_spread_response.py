...
if TYPE_CHECKING:
    from ..models.expense_spread_period import ExpenseSpreadPeriod


T = TypeVar("T", bound="ReadWBSExpenseSpreadResponse")


@_attrs_define
class ReadWBSExpenseSpreadResponse:
    ...
    Attributes:
        ...
        period (list[ExpenseSpreadPeriod] | Unset):
    """
    ...
    period: list[ExpenseSpreadPeriod] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _period is not UNSET:
            ...
            for period_item_data in _period:
                period_item = ExpenseSpreadPeriod.from_dict(period_item_data)

                period.append(period_item)

        read_wbs_expense_spread_response = cls(
            wbs_code=wbs_code,
        ...
        read_wbs_expense_spread_response.additional_properties = d
        return read_wbs_expense_spread_response
