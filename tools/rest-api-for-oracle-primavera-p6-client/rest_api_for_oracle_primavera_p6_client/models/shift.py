...
from ..models.shift_field_item import ShiftFieldItem
...
class Shift:
    ...
    Attributes:
        ...
        field (list[ShiftFieldItem] | Unset): List of Fields for Shift Business Object
    """

    include: bool | Unset = UNSET
    field: list[ShiftFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ShiftFieldItem(field_item_data)
