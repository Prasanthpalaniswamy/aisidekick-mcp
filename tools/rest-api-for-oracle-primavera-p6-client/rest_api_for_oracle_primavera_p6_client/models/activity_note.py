...
from ..models.activity_note_field_item import ActivityNoteFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ActivityNote")
...
class ActivityNote:
    ...
    Attributes:
        ...
        field (list[ActivityNoteFieldItem] | Unset): List of Fields for ActivityNote Business Object
    """

    include: bool | Unset = UNSET
    field: list[ActivityNoteFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ActivityNoteFieldItem(field_item_data)
        ...
        activity_note.additional_properties = d
