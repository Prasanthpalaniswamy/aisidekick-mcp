...
from ..models.document_status_code_field_item import DocumentStatusCodeFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="DocumentStatusCode")
...
class DocumentStatusCode:
    ...
    Attributes:
        ...
        field (list[DocumentStatusCodeFieldItem] | Unset): List of Fields for DocumentStatusCode Business Object
    """

    include: bool | Unset = UNSET
    field: list[DocumentStatusCodeFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = DocumentStatusCodeFieldItem(field_item_data)

                field.append(field_item)

        document_status_code = cls(
            include=include,
            field=field,
        )

        document_status_code.additional_properties = d
        return document_status_code
