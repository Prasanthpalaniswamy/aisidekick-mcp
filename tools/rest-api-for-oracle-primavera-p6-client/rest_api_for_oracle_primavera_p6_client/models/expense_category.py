...
from ..models.expense_category_field_item import ExpenseCategoryFieldItem
...
class ExpenseCategory:
    ...
    Attributes:
        ...
        field (list[ExpenseCategoryFieldItem] | Unset): List of Fields for ExpenseCategory Business Object
    """

    include: bool | Unset = UNSET
    field: list[ExpenseCategoryFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ExpenseCategoryFieldItem(field_item_data)
