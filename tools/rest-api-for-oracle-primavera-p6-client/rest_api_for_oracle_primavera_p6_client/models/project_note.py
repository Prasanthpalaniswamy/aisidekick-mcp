...
from ..models.project_note_field_item import ProjectNoteFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectNote")
...
class ProjectNote:
    ...
    Attributes:
        ...
        field (list[ProjectNoteFieldItem] | Unset): List of Fields for ProjectNote Business Object
    """

    include: bool | Unset = UNSET
    field: list[ProjectNoteFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ProjectNoteFieldItem(field_item_data)
        ...
        project_note.additional_properties = d
        return project_note
