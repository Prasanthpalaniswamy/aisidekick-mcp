...
class UserLicense:
    ...
    Attributes:
        create_date (datetime.datetime | Unset): The date this user license was created.
        create_user (str | Unset): The name of the user that created this user license.
        last_update_date (datetime.datetime | Unset): The date this user license was last updated.
        last_update_user (str | Unset): The name of the user that last updated this user license.
        license_type (str | Unset): The property that permits you to configure access to different functional areas of
