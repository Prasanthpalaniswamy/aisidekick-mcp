...
from ..models.wbs_field_item import WBSFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="WBS")
...
class WBS:
    ...
    Attributes:
        ...
        field (list[WBSFieldItem] | Unset): List of Fields for WBS Business Object
    """

    include: bool | Unset = UNSET
    field: list[WBSFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = WBSFieldItem(field_item_data)
