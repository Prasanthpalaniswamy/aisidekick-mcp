...
from ..models.risk_matrix_field_item import RiskMatrixFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="RiskMatrix")
...
class RiskMatrix:
    ...
    Attributes:
        ...
        field (list[RiskMatrixFieldItem] | Unset): List of Fields for RiskMatrix Business Object
    """

    include: bool | Unset = UNSET
    field: list[RiskMatrixFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = RiskMatrixFieldItem(field_item_data)
        ...
        risk_matrix.additional_properties = d
        return risk_matrix
