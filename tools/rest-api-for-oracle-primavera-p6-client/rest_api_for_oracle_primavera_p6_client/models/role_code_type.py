...
from ..models.role_code_type_field_item import RoleCodeTypeFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="RoleCodeType")
...
class RoleCodeType:
    ...
    Attributes:
        ...
        field (list[RoleCodeTypeFieldItem] | Unset): List of Fields for RoleCodeType Business Object
    """

    include: bool | Unset = UNSET
    field: list[RoleCodeTypeFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = RoleCodeTypeFieldItem(field_item_data)
        ...
        role_code_type.additional_properties = d
        return role_code_type
