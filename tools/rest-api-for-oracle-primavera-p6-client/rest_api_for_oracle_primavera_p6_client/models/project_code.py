...
from ..models.project_code_field_item import ProjectCodeFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCode")
...
class ProjectCode:
    ...
    Attributes:
        ...
        field (list[ProjectCodeFieldItem] | Unset): List of Fields for ProjectCode Business Object
    """

    include: bool | Unset = UNSET
    field: list[ProjectCodeFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ProjectCodeFieldItem(field_item_data)
        ...
        project_code.additional_properties = d
        return project_code
