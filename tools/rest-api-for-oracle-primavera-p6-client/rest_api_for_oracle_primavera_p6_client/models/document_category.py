...
class DocumentCategory:
    ...
    Attributes:
        ...
        create_date (datetime.datetime | Unset): The date this document category was created.
        create_user (str | Unset): The name of the user that created this document category.
        last_update_date (datetime.datetime | Unset): The date this document category was last updated.
        last_update_user (str | Unset): The name of the user that last updated this document category.
