...
T = TypeVar("T", bound="EPSSpendingPlan")
...
class EPSSpendingPlan:
    ...
    Attributes:
        date (datetime.datetime): The start of a spending/benefit plan time period for the EPS.
        eps_object_id (int): The unique ID of the associated EPS for this EPS spending plan.
        benefit_plan (float | Unset): The editable monthly profit portion for each month for the EPS.
        create_date (datetime.datetime | Unset): The date this EPS Spending plan was created.
        create_user (str | Unset): The name of the user that created this EPS Spending plan.
        eps_id (str | Unset): The short code assigned to the associated EPS.
        eps_name (str | Unset): The name of the EPS element associated with this spending plan.
        last_update_date (datetime.datetime | Unset): The date this EPS Spending plan was last updated.
        last_update_user (str | Unset): The name of the user that last updated this EPS Spending plan.
        object_id (int | Unset): The unique ID generated by the system.
        spending_plan (float | Unset): The editable total monthly expenditure for the EPS.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        eps_spending_plan.additional_properties = d
        return eps_spending_plan
