...
T = TypeVar("T", bound="DeleteResourceCodeAssignments")


@_attrs_define
class DeleteResourceCodeAssignments:
    """DeleteResourceCodeAssignments Entity

    Attributes:
        resource_object_id (int | Unset):
        resource_code_type_object_id (int | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_code_assignments = cls(
            resource_object_id=resource_object_id,
            resource_code_type_object_id=resource_code_type_object_id,
        )

        delete_resource_code_assignments.additional_properties = d
        return delete_resource_code_assignments
