...
T = TypeVar("T", bound="DeleteResourceAssignmentPeriodActuals")


@_attrs_define
class DeleteResourceAssignmentPeriodActuals:
    """DeleteResourceAssignmentPeriodActuals Entity
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_resource_assignment_period_actuals = cls(
            financial_period_object_id=financial_period_object_id,
            resource_assignment_object_id=resource_assignment_object_id,
        )

        delete_resource_assignment_period_actuals.additional_properties = d
        return delete_resource_assignment_period_actuals
