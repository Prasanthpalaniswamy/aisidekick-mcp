...
from ..models.threshold_parameter_field_item import ThresholdParameterFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ThresholdParameter")
...
class ThresholdParameter:
    ...
    Attributes:
        ...
        field (list[ThresholdParameterFieldItem] | Unset): List of Fields for ThresholdParameter Business Object
    """

    include: bool | Unset = UNSET
    field: list[ThresholdParameterFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ThresholdParameterFieldItem(field_item_data)

                field.append(field_item)

        threshold_parameter = cls(
            include=include,
            field=field,
        )

        threshold_parameter.additional_properties = d
