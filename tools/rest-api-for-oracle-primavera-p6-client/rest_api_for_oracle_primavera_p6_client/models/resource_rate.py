...
from ..models.resource_rate_field_item import ResourceRateFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResourceRate")
...
class ResourceRate:
    ...
    Attributes:
        ...
        field (list[ResourceRateFieldItem] | Unset): List of Fields for ResourceRate Business Object
    """

    include: bool | Unset = UNSET
    field: list[ResourceRateFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = ResourceRateFieldItem(field_item_data)
        ...
        resource_rate.additional_properties = d
