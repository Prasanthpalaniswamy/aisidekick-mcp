...
T = TypeVar("T", bound="ReadWBSRoleSpreadResponse")


@_attrs_define
class ReadWBSRoleSpreadResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        read_wbs_role_spread_response = cls(
            wbs_code=wbs_code,
        ...
        read_wbs_role_spread_response.additional_properties = d
        return read_wbs_role_spread_response
