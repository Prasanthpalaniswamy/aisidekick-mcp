...
from ..models.risk_response_action_field_item import RiskResponseActionFieldItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="RiskResponseAction")
...
class RiskResponseAction:
    ...
    Attributes:
        ...
        field (list[RiskResponseActionFieldItem] | Unset): List of Fields for RiskResponseAction Business Object
    """

    include: bool | Unset = UNSET
    field: list[RiskResponseActionFieldItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _field is not UNSET:
            ...
            for field_item_data in _field:
                field_item = RiskResponseActionFieldItem(field_item_data)

                field.append(field_item)

        risk_response_action = cls(
            include=include,
            field=field,
        )

        risk_response_action.additional_properties = d
        return risk_response_action
