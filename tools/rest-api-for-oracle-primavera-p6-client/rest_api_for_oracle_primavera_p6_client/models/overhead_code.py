...
T = TypeVar("T", bound="OverheadCode")
...
class OverheadCode:
    ...
    Attributes:
        ...
        create_date (datetime.datetime | Unset): The date this nonworktype was created.
        create_user (str | Unset): The name of the user that created this nonworktype.
        last_update_date (datetime.datetime | Unset): The date this nonworktype was last updated.
        last_update_user (str | Unset): The name of the user that last updated this nonworktype.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        overhead_code.additional_properties = d
