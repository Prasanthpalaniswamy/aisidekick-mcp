...
T = TypeVar("T", bound="CreateResourceCodeAssignmentsResponse")


@_attrs_define
class CreateResourceCodeAssignmentsResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_resource_code_assignments_response = cls(
            resource_code_type_object_id=resource_code_type_object_id,
            resource_object_id=resource_object_id,
        )

        create_resource_code_assignments_response.additional_properties = d
        return create_resource_code_assignments_response
