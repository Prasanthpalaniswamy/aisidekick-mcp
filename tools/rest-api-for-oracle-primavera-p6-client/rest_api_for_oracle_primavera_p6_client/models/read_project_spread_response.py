...
T = TypeVar("T", bound="ReadProjectSpreadResponse")


@_attrs_define
class ReadProjectSpreadResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        read_project_spread_response = cls(
        ...
        read_project_spread_response.additional_properties = d
        return read_project_spread_response
